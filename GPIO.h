...
/********************************************************************************************/
/*!
 	 \brief This initialize the SW3 interrupts enabled
 	 \param[in] void
 	 \return void
 */
void SW3_init(void);
/********************************************************************************************/
/*!
 	 \brief This initialize the SW2 interrupts enabled
 	 \param[in] void
 	 \return void
 */
void SW2_init(void);
/********************************************************************************************/
/*!
 	 \brief	This function initialize the GPIO pins required for the external leds
...
/********************************************************************************************/
/*!
 	 \brief	Initialize the callback for the selected port
  	 \param[in]  gpio_port_name_t
 */
void GPIO_callback_init(gpio_port_name_t port_name,void (*handler)(void));

/********************************************************************************************/
/*!
 	 \brief	Clear the flags for the selected port
  	 \param[in]  gpio_port_name_t
 */
...
/********************************************************************************************/
/*!
 	 \brief	returns the flag value of the selected port
  	 \param[in]  gpio_port_name_t
  	 \return uint8_t
 */
